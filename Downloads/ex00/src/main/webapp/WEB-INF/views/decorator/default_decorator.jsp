		...
		<nav class="navbar navbar-expand-md bg-dark navbar-dark">
			...
			<ul class="navbar-nav mr-auto">
				...
				<c:if test="${(!empty login)&&(login.gradeNo==9) }">
					<li class="nav-item">
				    	<a class="nav-link" href="/goods/list.do">Product Edit</a>
				   </li>
				</c:if>
			...
			<ul class="navbar-nav">
				<c:if test="${ empty login }">
					...
					<li class="nav-item">
						...
						<i class="fa fa-address-card-o"></i> Join</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="/member/searchID.do">
						<i class="fa fa-search"></i> search ID/PW</a>
					</li>
				</c:if>
				<c:if test="${ !empty login }">
					<!-- 로그인 했을 때 -->
